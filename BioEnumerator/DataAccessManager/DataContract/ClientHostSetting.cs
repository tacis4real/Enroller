...
namespace BioEnumerator.DataAccessManager.DataContract
{
    public class ClientStation
    {
        ...
        [Required(ErrorMessageResourceType = typeof(Resources), ErrorMessage = @"Local_Government_Area_is_required")]
        [CheckNumber(0, ErrorMessageResourceType = typeof(Resources), ErrorMessage = @"Invalid_Local_Government_Area_Information")]
