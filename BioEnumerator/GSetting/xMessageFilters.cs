...
namespace BioEnumerator.GSetting
{
        ...
        internal enum WindowsMessages : int
    {
        ...
        LM_GETITEM = (WM_USER + 0x303)
         ...
         //[System.Security.Permissions.PermissionSet(System.Security.Permissions.Security‌​Action.Demand, Name = "FullTrust")]
         public  class MouseMessageFilter : IMessageFilter, IDisposable
        {
	        ...
	        {
                if (m.Msg == Convert.ToInt32(WindowsMessages.WM_MOUSEMOVE))
	            {
                    ...
                    if (previousMousePosition != currentMousePoint)
                    {
                        ...
                        if (MouseMove != null)
                        {
                            MouseMove(this, new MouseEventArgs(MouseButtons.None, 0, currentMousePoint.X, currentMousePoint.Y, 0));
                        }
                    }
	               
	            }
	            if (m.Msg == Convert.ToInt32(WindowsMessages.WM_LBUTTONUP))
	            {
                    System.Drawing.Point currentMousePoint = Control.MousePosition;
                    if (MouseClick != null)
                    {
                        MouseClick(Control.FromHandle(m.HWnd), new MouseEventArgs(MouseButtons.None, 0, currentMousePoint.X, currentMousePoint.Y, 0));
                    }
	        ...
	        #region Events
                ...
                public delegate void xMouseEventHandler(object source, MouseEventArgs e);
                public event xMouseEventHandler MouseMove;
                public event xMouseEventHandler MouseDown;
                public event xMouseEventHandler MouseUp;
                public event xMouseEventHandler MouseClick;
